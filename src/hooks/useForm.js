...
export default function useForm(inputValues) {
  ...
  const setValidity = (name, value, isValid, validationMessage) => {
  ...
  const handleChange = (event) => {
    ...
    setValidity(name, value, isValid, validationMessage)
  }
  ...
  return {formState, handleChange, resetForm, setValidity}
}